...
class CampaignsTest < ApplicationSystemTestCase
  ...
  test "creating a Campaign" do
    ...
    fill_in "District", with: @campaign.district_id
    fill_in "Election date", with: @campaign.election_date
    fill_in "Election type", with: @campaign.election_type
    fill_in "Number of winners", with: @campaign.number_of_winners
