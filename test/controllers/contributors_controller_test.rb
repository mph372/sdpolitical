...
class ContributorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contributor" do
    assert_difference('Contributor.count') do
      post contributors_url, params: { contributor: { first_name: @contributor.first_name, last_name: @contributor.last_name, transaction_id: @contributor.transaction_id } }
    end
  ...
  test "should update contributor" do
    patch contributor_url(@contributor), params: { contributor: { first_name: @contributor.first_name, last_name: @contributor.last_name, transaction_id: @contributor.transaction_id } }
