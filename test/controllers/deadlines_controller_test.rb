...
class DeadlinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deadline" do
    assert_difference('Deadline.count') do
      post deadlines_url, params: { deadline: { deadline_date: @deadline.deadline_date, description: @deadline.description, title: @deadline.title } }
    end
  ...
  test "should update deadline" do
    patch deadline_url(@deadline), params: { deadline: { deadline_date: @deadline.deadline_date, description: @deadline.description, title: @deadline.title } }
