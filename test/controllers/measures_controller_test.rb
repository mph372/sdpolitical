...
class MeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post measures_url, params: { measure: { jurisdiction_id: @measure.jurisdiction_id, letter: @measure.letter, origin: @measure.origin, text: @measure.text, threshold: @measure.threshold, topic: @measure.topic, type: @measure.type } }
    end
  ...
  test "should update measure" do
    patch measure_url(@measure), params: { measure: { jurisdiction_id: @measure.jurisdiction_id, letter: @measure.letter, origin: @measure.origin, text: @measure.text, threshold: @measure.threshold, topic: @measure.topic, type: @measure.type } }
