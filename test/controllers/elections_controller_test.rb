...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post elections_url, params: { election: { district_id: @election.district_id, election_type: @election.election_type, year: @election.year } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { district_id: @election.district_id, election_type: @election.election_type, year: @election.year } }
