...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference('Vendor.count') do
      post vendors_url, params: { vendor: { first_name: @vendor.first_name, last_name: @vendor.last_name } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { first_name: @vendor.first_name, last_name: @vendor.last_name } }
