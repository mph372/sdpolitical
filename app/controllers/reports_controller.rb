class ReportsController < ApplicationController
  ...
  private
    ...
    def report_params
      params.require(:report).permit(:person_id, :period_begin, :period_end, :report_filed, :period_receipts,	:period_disbursements,	:current_coh,	 :current_debt, :candidate_id )
    end
end
